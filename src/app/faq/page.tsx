...
const FAQS: Array<{ q: string; a: string; links?: Array<{ href: string; label: string }> }> = [
  ...
  },
  {
    ...
    a: "농림축산식품부 동물보호관리시스템 공공데이터를 매시간 동기화합니다. 보호 공고 목록은 진행 중인 공고(OPEN)를 기본으로 보여주며, 공고 종료(CLOSED)와 전체 필터로 종료 공고도 안내 문구와 함께 다시 볼 수 있습니다. 공고 종료는 동물의 현재 보호·입양·반환 등 최종 상태를 뜻하지 않으므로, 현재 상태는 해당 보호소에 확인해 주세요.",
  },
  {
