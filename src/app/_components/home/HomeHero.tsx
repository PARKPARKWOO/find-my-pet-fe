  ...
  return (
    <section className="grid gap-8 px-4 py-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(22rem,0.95fr)] lg:items-start lg:px-8 lg:py-16">
      <div className="space-y-7">
        <div>
          <p className="text-sm font-semibold tracking-wide text-accent-readable">이웃과 잇는 반려동물 소식</p>
          <h1 className="mt-3 max-w-2xl break-keep text-balance font-editorial text-4xl font-semibold leading-tight tracking-tight text-content-primary sm:text-5xl">다시 만나는 길을, 동네와 함께.</h1>
